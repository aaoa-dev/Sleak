...
- **Layout & spacing**, drafted; avoid full-bleed section dividers and keep repeated content on stable rails ([layout-spacing.md](references/layout-spacing.md))
...
- **Typography**, drafted; includes tabular figures and aligned numeric columns ([typography.md](references/typography.md))
